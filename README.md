...
Math Edu:
```bash
python src/math-edu/run_math_edu_skill.py --base-url http://127.0.0.1:1025 [OPTIONS]
```
...
- Remember to change the file directories. For detailed info check [Here for Doc](src/math-edu/README.md)
